...
public class Main extends Application {
    ...
    @Override public void init() {
        ...
        // Main Value
        AnchorPane.setTopAnchor(mainPane, 47d);
    ...
    private void drawChart() {
        ...
        ctx.setStroke(darkMode ? Constants.GRAY : Color.rgb(170, 169, 169));
